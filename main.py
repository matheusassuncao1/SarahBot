...
@tree.command(
    guild=discord.Object(id=id_do_servidor),
    name='Ping',
    description='Retorne o valor Pong')  #Comando específico para seu servidor
...
@tree.command(
    guild=discord.Object(id=id_do_servidor),
    name='D20',
    description='Jogue o dado D20 e descubra a sua sorte')  #Comando específico para seu servidor
